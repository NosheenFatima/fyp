                                ...
                                <div class="single-services text-center mb-30">
                                    <div class="services-ion">
                                        @if ($category->category_image)
                                            <img src="{{ asset('storage/' . $category->category_image) }}" alt="{{ $category->job_title }}" style="max-width: 80px; max-height: 80px;">
                                        @else
                                            <span class="flaticon-tour"></span> @endif
                                    </div>
                                    <div class="services-cap">
                                        <h5><a href="">{{ $category->job_title }}</a></h5>
                                    </div>
                                </div>
                            </div>
                        @endforeach
